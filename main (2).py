...
class Bot(BaseBot):
    ...
    async def on_chat(self, user: User, message: str) -> None:
        ...
        if        message.startswith("Help") or      message.startswith("/help") or      message.startswith("!help") or message.startswith("help"):
            await self.highrise.chat(f"/emote list | /peoples | /emotes | /teles | /marry me? | /play | /fish | /userinfo @ | !emoteall | !tele @ | !summon @ | !kick @ | !tele z,y,x | !tele @ z,y,x | ")
        ...
        if message.startswith("!vip"):
          if user.username == "____Rayen____" or user.username == "superhotgirll" or user.username == "eva__63":
        ...
        if message.lower().startswith("!tipall ") and user.username == "superhotgirll" or user.username == "____Rayen____" or user.username == "eva__63":
              parts = message.split(" ")
              if len(parts) != 2:
    ...
    async def on_whisper(self, user: User, message: str) -> None:
        ...
        if message.startswith("!vip"):
          if user.username == "____Rayen____" or user.username == "ShoKytoo" or user.username == "eva__63":
            await self.highrise.teleport(user.id, Position(16.5 , 13.75 , 27.0))
