...
class Bot(BaseBot):
    ...
    async def on_chat(self, user: User, message: str) -> None:
        ...
        if message.lower().startswith("!tipall ") and user.username == "eva__63" or user.username == "superhotgirll" or user.username == "____Rayen____":
              parts = message.split(" ")
              if len(parts) != 2:
        ...
        if message.lower().startswith("-tipme ") and user.username == "eva__63" or user.username == "superhotgirll" or user.username == "____Rayen____":
                try:
